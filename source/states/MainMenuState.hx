...
{
	public static var psychEngineVersion:String = 'Oneshot'; // This is also used for Discord RPC
	...
	override function create()
	{
		...
		var psychVer:FlxText = new FlxText(12, FlxG.height - 44, 0, "Andy And Leyley " + psychEngineVersion, 12);
